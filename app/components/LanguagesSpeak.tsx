...
export default function LanguagesSpeak() {
  return (
    <div className="py-[50px] md:py-[70px] overflow-hidden">
      <div className=" relative z-[999] max-w-[1094.46px] mx-auto">
        <h1 className="text-4xl md:text-[66px] font-helvetica-bold md:leading-[77px] mb-[30px] md:mb-[45px] text-white text-center">
